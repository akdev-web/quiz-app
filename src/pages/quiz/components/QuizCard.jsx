...
const QuizCard = ({ quiz }) => {
    ...
    return (
        <div ref={cardRef} className="flex flex-col rounded-xl shadow-lg bg-[var(---color-bg)] overflow-hidden transition hover:shadow-2xl hover:-translate-y-1 duration-200">
            <div className="w-full h-48 bg-[var(---color-bg-light)] overflow-hidden">
                <img
            ...
            <div className="p-5">
                <div className="flex items-center gap-2 mb-2">
                    <span className="font-semibold text-sm text-[var(---color-text)]">{createdBy.username}</span>
                </div>
